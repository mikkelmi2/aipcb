...
| | |
|---|---|
| [`reports/`](reports/) | **Delivery reports — the best place to start.** One per milestone, each stating what was asked for, what was delivered, what was *not* delivered, and the measurements behind every claim. They are written to be read by someone who wasn't there. [`reports/m18.md`](reports/m18.md) is the most recent; [`reports/m14.md`](reports/m14.md) is the most representative. |
